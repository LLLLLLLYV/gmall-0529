...
public class CatalogServiceImpl implements CatalogService {
    ...
    public List<BaseCatalog2> getAllBaseCatalog2ByC1Id(Integer C1Id) {
        QueryWrapper<BaseCatalog2> queryWrapper = new QueryWrapper<BaseCatalog2>().eq("catalog1_id", C1Id);
        return baseCatalog2Mapper.selectList(queryWrapper);
    }

    @Override
    public List<BaseCatalog3> getAllBaseCatalog3(Integer C2Id) {
        QueryWrapper<BaseCatalog3> queryWrapper = new QueryWrapper<BaseCatalog3>().eq("catalog2_id", C2Id);
